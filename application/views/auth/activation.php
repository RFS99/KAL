            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
              <div class="card shadow-2-strong card-login">
                <div class="card-body p-5">
                  <h3 class="mb-5 text-center text-title">Aktivasi Akun</h3>
                  <form id="form-login" action="<?=base_url('activation/save')?>" method="post">
                    <div class="form-outline mb-4">
                      <input type="email" placeholder="Email" name="email" class="form-control form-control-lg" />
                    </div>
                    <button class="btn btn-lg btn-block btn-login" type="submit">Submit</button>
                  </form>
